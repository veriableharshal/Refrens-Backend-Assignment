...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen w-screen bg-purple-950 flex items-center justify-center">
      <div className="h-72 w-72 rounded-lg shadow-lg flex flex-col items-center justify-between p-2.5 gap-1.5 bg-purple-600">
        ...
        <label htmlFor="file" className="bg-violet-700 w-full h-10 px-2 rounded-lg cursor-pointer flex items-center justify-end text-white  border-none">
          ...
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-5 fill-current text-royalblue bg-[rgba(70,66,66,0.103)] rounded-full p-0.5 cursor-pointer shadow-md">
